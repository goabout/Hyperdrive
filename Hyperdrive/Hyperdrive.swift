...
public class Hyperdrive {
  ...
  public func request(transition:HTTPTransition, parameters:[String:AnyObject]? = nil, attributes:[String:AnyObject]? = nil, method:String? = nil, completion:(RepresentorResult -> Void)) {
